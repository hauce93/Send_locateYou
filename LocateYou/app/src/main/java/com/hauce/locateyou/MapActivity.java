...
public class MapActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSails.setOnLocationChangeEventListener(new SAILS.OnLocationChangeEventListener() {
            ...
            public void OnLocationChange() {
                ...
                if (mSailsMapView.isCenterLock() && !mSailsMapView.isInLocationFloor() && !mSails.getFloor().equals("") && mSails.isLocationFix()) {
                    ...
                    mSailsMapView.getMapViewPosition().setZoomLevel((byte) 13);
        ...
        mSailsMapView.post(new Runnable() {
            ...
            public void run() {
                ...
                mSails.loadCloudBuilding("d31ced078f95452d8cce6126982863ba", "543e81de1579fded7e0000f5", new SAILS.OnFinishCallback() {
                ...
                switch (sf.nodeType) {
                    case PathRoutingManager.SwitchFloorInfo.ELEVATOR:
                        if (sf.direction == PathRoutingManager.SwitchFloorInfo.UP)
                            msgView.setText("Navigation Tips :\n Please take the elevator upstairs to " + mSails.getFloorDescription(sf.toFloorname));
                        else if (sf.direction == PathRoutingManager.SwitchFloorInfo.DOWN)
                            msgView.setText("Navigation Tips :\n Please take the elevator downstairs to " + mSails.getFloorDescription(sf.toFloorname));
                        break;

                    case PathRoutingManager.SwitchFloorInfo.ESCALATOR:
                        if (sf.direction == PathRoutingManager.SwitchFloorInfo.UP)
                            msgView.setText("Navigation Tips : \n Please take the escalator upstairs to " + mSails.getFloorDescription(sf.toFloorname));
                        else if (sf.direction == PathRoutingManager.SwitchFloorInfo.DOWN)
                            msgView.setText("Navigation Tips : \n Please take the escalator downstairs to " + mSails.getFloorDescription(sf.toFloorname));
                        break;

                    case PathRoutingManager.SwitchFloorInfo.STAIR:
                        if (sf.direction == PathRoutingManager.SwitchFloorInfo.UP)
                            msgView.setText("Navigation Tips : \n Please take the stairs up to " + mSails.getFloorDescription(sf.toFloorname));
                        else if (sf.direction == PathRoutingManager.SwitchFloorInfo.DOWN)
                            msgView.setText("Navigation Tips : \n Please take the stairs down to " + mSails.getFloorDescription(sf.toFloorname));
                        break;

                    case PathRoutingManager.SwitchFloorInfo.DESTINATION:
                        msgView.setText(" Navigation Tips : \n Move forward to " + sf.fromBelongsRegion.getName());
                        break;
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.start_location_engine:
                ...
                } else if (mSails.checkMode(SAILS.BLE_GFP_IMU) || mSails.checkMode(SAILS.BLE_ADVERTISING)) {
    ...
    class ExpandableAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            tv.setText(text);
            linearLayout.setBackgroundColor(Color.parseColor("#ffcddbdb"));
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            linearLayout.setBackgroundColor(Color.parseColor("#FFB7DBD5"));
            tv.setTextColor(getResources().getColor(android.R.color.black));
