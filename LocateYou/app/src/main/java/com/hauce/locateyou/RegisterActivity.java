...
import com.hauce.libraries.DatabaseHandler;
import com.hauce.libraries.UserFunctions;

import org.json.JSONException;
import org.json.JSONObject;

/**
 * Created by hauce on 06/10/2014.
 */
                ...
                try {
                    if (json.getString(KEY_SUCCESS) != null) {
                        ...
                        if(Integer.parseInt(res) == 1){
                            ...
                            registerErrorMsg.setText("Name field are empty");
                        }
                        else if(Integer.parseInt(err) == 3){
                            registerErrorMsg.setText("Email field are empty");
                        }
                            ...
                            registerErrorMsg.setText("Minimum password length is 4");
                        }
                    }
